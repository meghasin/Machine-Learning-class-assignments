...
def part2Classification(vocab, training, trumpwordCount, clintwordCount, clinVocabtrueCount, trumpVocabtrueCount, testTrumpProbs, testClintonProbs):
    ...
    # for probFreq in len(trumpProb):
        # if(trumpProb[probFreq+1]<trumpProb[probFreq]):
            # max=trumpProb[probFreq]
...
def part1Classifier(vocab, training, testing, trainLabels, devLabels):
    ...
    part2Classification(vocab, training, trainingTrumpVocabProbs, trainingClintonVocabProbs, clinVocabtrueCount, trumpVocabtrueCount, trumpTrainingResults, clintonTrainingResults)
    ...
    trumpTrainAcc = part1Accuracy(training, trumpTrainingResults, trainLabels, 1)
    print "Accuracy rating 1 done!"
    clintonTrainAcc = part1Accuracy(training, clintonTrainingResults, trainLabels, 0)
